const audio = [
    {
      audioSrc: "../../src/audio/words-audio/house/01.wav",
    ...
    {
      audioSrc: "../../src/audio/words-audio/house/02.wav",
    ...
    {
      audioSrc: "../../src/audio/words-audio/house/03.wav",
    ...
    {
      audioSrc: "../../src/audio/words-audio/house/04.wav",
    ...
    {
      audioSrc: "../../src/audio/words-audio/house/05.wav",
    ...
    {
      audioSrc: "../../src/audio/words-audio/house/06.wav",
    ...
    {
      audioSrc: "../../src/audio/words-audio/house/07.wav",
    ...
    {
      audioSrc: "../../src/audio/words-audio/house/08.wav",
      imageSrc: "../../src/img/words-img/house/08.jpg",
      tamil: "வரவேற்பறை ",
      pronunciation:"Varevetpuarai",
      english: "Reception Romm"
    },          
    {
      audioSrc: "../../src/audio/words-audio/house/09.wav",
    ...
    {
      audioSrc: "../../src/audio/words-audio/house/10.wav",
    ...
    {
      audioSrc: "../../src/audio/words-audio/house/11.wav",
      imageSrc: "../../src/img/words-img/house/11.jpg",
      tamil: "கிணறு ",
      pronunciation: "Kiranu",
      english: "Well"
    },
    {
      audioSrc: "../../src/audio/words-audio/house/12.wav",
    ...
    {
      audioSrc: "../../src/audio/words-audio/house/13.wav",
    ...
    {
      audioSrc: "../../src/audio/words-audio/house/14.wav",
    ...
    {
      audioSrc: "../../src/audio/words-audio/house/15.wav",
    ...
    {
      audioSrc: "../../src/audio/words-audio/house/16.wav",
    ...
    {
      audioSrc: "../../src/audio/words-audio/house/17.wav",
    ...
    {
      audioSrc: "../../src/audio/words-audio/house/18.wav",
      imageSrc: "../../src/img/words-img/house/18.jpg",
      tamil: "சாப்பாட்டு மேசை ",
      pronunciation: "Sappadu Mesai",
